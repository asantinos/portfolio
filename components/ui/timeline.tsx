        ...
        <div className="w-full font-sans md:px-10" ref={containerRef}>
            {/* <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
                    My Journey Through Entrepreneurship
                </h2>
                <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-md">
                    A timeline of key moments that shaped my mindset, work, and
                    the projects I’ve built along the way — from early
                    experiments to running my own agency.
                </p>
            </div> */}
            ...
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                ...
                >
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0  w-0.5 bg-linear-to-t from-blue-600 via-blue-500 to-transparent from-0% via-10% rounded-full"
                    />
                </div>
            </div>
        </div>
